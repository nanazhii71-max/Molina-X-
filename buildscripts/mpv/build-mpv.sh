#!/usr/bin/env bash
# MolinaX Manager - libmpv Build Script with Lua Scripting Enabled
...
PREFIX_PACKAGE="com.molinax.manager"
TARGET_ABIS=("arm64-v8a" "armeabi-v7a")

echo "=== Building libmpv for MolinaX Manager (${PREFIX_PACKAGE}) ==="
