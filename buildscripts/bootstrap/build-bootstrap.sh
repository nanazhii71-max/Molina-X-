#!/usr/bin/env bash
# Molina-X - Bootstrap Build Script
# Rebuilds Termux packages bootstrap targeting com.molinax
# PREFIX = /data/data/com.molinax/files/usr
# HOME   = /data/data/com.molinax/files/home

set -euo pipefail

PACKAGE_NAME="com.molinax"
...
for ABI in "${TARGET_ABIS[@]}"; do
    ...
    # Output: bootstrap-${ABI}.zip containing $PREFIX binaries compiled with Hardcoded /data/data/com.molinax/files/usr
